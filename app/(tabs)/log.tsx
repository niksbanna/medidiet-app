...
// Sample food database for quick logging
const QUICK_FOODS: MealItem[] = [
  {
    id: 'quick_1',
    name: 'Banana (medium)',
    portion: '1 piece',
    nutrients: { calories: 105, protein: 1, carbs: 27, fat: 0, fiber: 3, sodium: 1, potassium: 422, calcium: 6, iron: 0 }
  },
  {
    id: 'quick_2',
    name: 'Apple (medium)',
    portion: '1 piece',
    nutrients: { calories: 95, protein: 0, carbs: 25, fat: 0, fiber: 4, sodium: 2, potassium: 195, calcium: 11, iron: 0 }
  },
  {
    id: 'quick_3',
    name: 'Greek Yogurt',
  ...
  },
  {
    ...
    portion: '1 slice',
    nutrients: { calories: 80, protein: 4, carbs: 14, fat: 1, fiber: 2, sodium: 170, potassium: 69, calcium: 30, iron: 1 }
  },
  {
    id: 'quick_5',
    name: 'Chicken Breast',
    portion: '3 oz cooked',
    nutrients: { calories: 140, protein: 26, carbs: 0, fat: 3, fiber: 0, sodium: 60, potassium: 220, calcium: 15, iron: 1 }
  }
];

export default function MealLogScreen() {
  const { mealLogs, addMealLog, userProfile } = useHealth();
  ...
  const getTotalCalories = (items: MealItem[]) => {
    return items.reduce((sum, item) => sum + item.nutrients.calories, 0);
  };
      ...
      >
        <View style={styles.header}>
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.subtitle}>Track your daily nutrition intake</Text>
          </View>
              ...
              <View style={styles.summaryStats}>
                <View style={styles.summaryItem}>
                  <View style={styles.summaryIconContainer}>
                    <MaterialIcons name="restaurant" size={24} color="#0066CC" />
                  </View>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Text style={styles.summaryValue}>
                    {Math.round(todayLogs.reduce((sum, log) => sum + getTotalCalories(log.items), 0))}
                  </Text>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Text style={styles.summaryValue}>
                    {todayLogs.length > 0 ? Math.round(todayLogs.reduce((sum, log) => sum + log.adherenceRating, 0) / todayLogs.length) : 0}
                  </Text>
          ...
          <View style={styles.section}>
            ...
            {todayLogs.length === 0 ? (
              <View style={styles.emptyState}>
                ...
                <Text style={styles.emptySubtext}>Start tracking your nutrition by logging your first meal</Text>
              </View>
            ) : (
              todayLogs.map((log) => {
                const mealType = MEAL_TYPES.find(type => type.key === log.mealType);
                  ...
                  >
                    <View style={styles.mealLogHeader}>
                      <View style={styles.mealTypeContainer}>
                        <View style={[styles.mealTypeIcon, { backgroundColor: `${mealColor}15` }]}>
                          <MaterialIcons 
                      ...
                      <View style={styles.mealLogStats}>
                        <View style={styles.caloriesBadge}>
                          <Text style={styles.caloriesText}>{getTotalCalories(log.items)}</Text>
                          <Text style={styles.caloriesLabel}>cal</Text>
                        </View>
                        <View style={styles.adherenceBadge}>
                          <MaterialIcons name="star" size={14} color="#FFD700" />
                          <Text style={styles.adherenceText}>{log.adherenceRating}/10</Text>
                        </View>
                      </View>
                    </View>
                    ...
                    <View style={styles.mealItems}>
                      {log.items.map((item, index) => (
                        <View key={index} style={styles.mealItemRow}>
                          <MaterialIcons name="circle" size={6} color="#0066CC" />
            ...
            <View style={[styles.section, { marginBottom: 20 }]}>
              ...
              >
                ...
                <View style={styles.medicalNoteContent}>
                  <Text style={styles.medicalNoteTitle}>Tracking for {userProfile.medicalCondition}</Text>
                  <Text style={styles.medicalNoteText}>
                    Consistent meal logging helps monitor your nutritional adherence and supports better health management.
                  </Text>
                </View>
              </LinearGradient>
            </View>
        ...
        <SafeAreaView style={styles.modalContainer} edges={['top']}>
          ...
          >
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity onPress={handleAddMeal} style={styles.modalSaveButton}>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
                ...
                {MEAL_TYPES.map((type) => (
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      selectedMealType === type.key && styles.mealTypeButtonSelected
                    ]}
                  ...
                  >
                    ...
                    <Text style={[
                      styles.mealTypeText,
                      selectedMealType === type.key && styles.mealTypeTextSelected
                    ]}>
                      {type.label}
                    </Text>
                  </TouchableOpacity>
            ...
            {/* Food Selection */}
            <View style={styles.modalSection}>
              <Text style={styles.modalSectionTitle}>Select Foods</Text>
              {QUICK_FOODS.map((food) => (
                <TouchableOpacity
                  key={food.id}
                  style={[
                    styles.foodItem,
                    selectedItems.find(item => item.id === food.id) && styles.foodItemSelected
                  ]}
            ...
            {/* Adherence Rating */}
            <View style={styles.modalSection}>
              <Text style={styles.modalSectionTitle}>How well did this meal fit your diet plan? (1-10)</Text>
            ...
            {selectedItems.length > 0 && (
              <View style={styles.modalSection}>
                <Text style={styles.modalSectionTitle}>Selected Items ({selectedItems.length})</Text>
